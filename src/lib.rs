...
#[derive(Debug)]
pub struct NovaRaftProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NovaRaftProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NovaRaft processing");
    
    let mut processor = NovaRaftProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NovaRaftProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NovaRaftProcessor::new(false);
